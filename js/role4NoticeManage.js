			...
			if(data.SUCCESS==true){				
				...
				for(var i=0;i<data.DATA.length;i++){
					if(data.DATA[i].ISPOST=="1")
						...
						var ISPOST="待审核";
					txt+="<tr class='industry' style='display:none;'><td class='tc'><input name='id[]' type='checkbox'  value='"+data.DATA[i].ID+"'></td><td class='lie_1'> <nobr><b><a href='notice.php?id="+data.DATA[i].ID+"'>"+data.DATA[i].MAINTITLE+"</b></nobr></td> <!--标签ID--><td class='lie_2'><nobr><b>"+data.DATA[i].AUTHOR+"</b></nobr> </td><td><b>"+data.DATA[i].CREATIME+"</b></td> <td><b>"+ISPOST+"</b></td></tr>";
