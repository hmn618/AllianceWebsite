       ...
       // alert("开心");
		...
		if(title==""||title==null||title==undefined){
			...
			return false;
                ...
                var url=$("#addPicId1").data("url");
		console.log("url:"+url);
		if($("#addPicId1").data("url")==""||$("#addPicId1").data("url")==null||$("#addPicId1").data("url")==undefined){
			alert("封面不能为空！");
			return false;
		}
