       ...
       // alert("开心");
		...
		if(title==""||title==null||title==undefined){
			...
			return false;
                ...
                var coverpicurl=document.getElementById('addPicId1').value;
		console.log("coverpicurl:"+coverpicurl);
		if(coverpicurl==""||coverpicurl==null||coverpicurl==undefined){
			alert("封面不能为空！");
			return false;
		}
		...
		$.ajax({
			...
			error:function(data) {//这是错误处理，会在console口输出一些状态号帮助我们查看错误原因
				var a=JSON.stringify(data);
				alert(a);
		    }
		});
