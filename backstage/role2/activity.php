...
<head>
	...
	<script charset="utf-8" src="../../js/role2activity.js"></script>
	...
	<div class="main_left">
		<div class="leftNav clearfix">
			...
			<ul id="leftNav">
				...
				<li class="active"><a href="publish_activities.php">发布活动<img src="../../img/企业会员/activity.png" class="icon" alt=""/></a></li>
			</ul>
		</div>
	</div>
		...
		<div class="right_bottom">
			...
			<div class="content">
				<div class="content_top">
					<div class="top_left">
						<a href="publish_activities.php"><span>管理</span></a>
					</div>
					<div class="top_right">
						<a href="#"><span>发起活动</span></a>
					</div>
				</div>
