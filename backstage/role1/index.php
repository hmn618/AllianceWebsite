...
<script type="text/javascript" src="../../js/role1index.js"></script>
...
<div class="main">
	<div class="main_left">
		<div class="leftNav clearfix">
			...
			<ul id="leftNav">
				<li class="active" id="shang"><a href="#">账号资料<img class="icon" src="../../img/user.png" alt=""/></a></li>
				<li><a href="basic.php">基本信息<img src="../../img/account/basic-info.png" class="icon"></a></li>
				<li ><a href="#" id="extend">扩展信息<img class="icon" src="../../img/account/ex-info.png" alt=""/></a>
							<ul class="sub">
				...
				<li><a href="#">提交材料<img src="../../img/account/material.png" class="icon" alt=""/></a></li>
